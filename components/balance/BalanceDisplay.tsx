...
export const BalanceDisplay: React.FC = () => {
  const houseBalance = useBynomoStore(state => state.houseBalance);
  const demoBalance = useBynomoStore(state => state.demoBalance);
  const accountType = useBynomoStore(state => state.accountType);
  const network = useBynomoStore(state => state.network);
  const toggleAccountType = useBynomoStore(state => state.toggleAccountType);
  const isLoading = useBynomoStore(state => state.isLoading);
  const address = useBynomoStore(state => state.address);
  ...
  const setAddress = useBynomoStore(state => state.setAddress);
  const setIsConnected = useBynomoStore(state => state.setIsConnected);
