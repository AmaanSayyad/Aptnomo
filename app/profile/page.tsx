    ...
    if (!isConnected) {
        return (
            <div className="min-h-screen bg-[#02040a] flex flex-col items-center justify-center p-6 text-center">
                ...
                <h1 className="text-2xl font-black text-white uppercase tracking-widest mb-4 font-orbitron">NOMO Registry</h1>
