...
const faqs = [
    ...
    },
    {
        ...
        answer: "Aptnomo supports a wide range of assets including major cryptos (BTC, ETH, SOL), precious metals (Gold, Silver), and top-tier stocks (AAPL, NVDA, TSLA) through Pyth price feeds."
    },
    {
    ...
    return (
        <main className="landing-layout selection:bg-purple-500/30">
                        ...
                        >
                            {Array.from("APTNOMO").map((letter, index) => (
                                <motion.h1
                                    ...
                                    className="text-[8vw] lg:text-[5.5rem] font-black leading-[0.8] tracking-tighter text-white"
            ...
            <footer className="py-24 px-10 border-t border-white/5 bg-black relative z-10 w-full overflow-hidden">
                <div className="huge-footer-logo text-[12vw] opacity-[0.03]">APTNOMO</div>
