...
export default function ReferralPage() {
    ...
    const shareOnX = () => {
        const text = encodeURIComponent(`Trade with millisecond precision on @APTNOMOProtocol! 🚀\n\nJoin using my referral link and earn rewards:`);
        ...
        <main className="min-h-screen bg-[#02040a] text-white relative overflow-hidden flex flex-col items-center py-12 px-4">
            ...
            <div className="relative z-10 w-full max-w-4xl">
                ...
                <header className="mb-12 text-center">
                    ...
                    >
                        Invite your friends to APTNOMO and climb the leaderboard. Each new trader using your code gets you closer to the top.
                    </motion.p>
                </header>
